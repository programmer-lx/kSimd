...
namespace ksimd
{
    ...
    // integer
    template<typename Tag>
    concept is_tag_integer = is_tag<Tag> && is_scalar_integer<tag_scalar_t<Tag>>;

    // i8
    template<typename Tag>
    concept is_tag_int8 = is_tag<Tag> && std::is_same_v<tag_scalar_t<Tag>, int8_t>;

    // u8
    template<typename Tag>
    concept is_tag_uint8 = is_tag<Tag> && std::is_same_v<tag_scalar_t<Tag>, uint8_t>;
    ...
    // i16
    template<typename Tag>
    concept is_tag_int16 = is_tag<Tag> && std::is_same_v<tag_scalar_t<Tag>, int16_t>;

    // u16
    template<typename Tag>
    concept is_tag_uint16 = is_tag<Tag> && std::is_same_v<tag_scalar_t<Tag>, uint16_t>;
    ...
    // u32
    template<typename Tag>
    concept is_tag_uint32 = is_tag<Tag> && std::is_same_v<tag_scalar_t<Tag>, uint32_t>;
    ...
    // i64
    template<typename Tag>
    concept is_tag_int64 = is_tag<Tag> && std::is_same_v<tag_scalar_t<Tag>, int64_t>;

    // u64
    template<typename Tag>
    concept is_tag_uint64 = is_tag<Tag> && std::is_same_v<tag_scalar_t<Tag>, uint64_t>;
