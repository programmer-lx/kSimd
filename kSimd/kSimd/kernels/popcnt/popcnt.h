...
#include "kSimd/kernels/kernel_api.h"
    ...
    /* shared lib */
        ...
        #define KSIMD_KERNEL_POPCNT_API KSIMD_DLL_EXPORT
    #else
        #define KSIMD_KERNEL_POPCNT_API KSIMD_DLL_IMPORT
    #endif
#else
    /* static lib */
...
static KSIMD_FORCE_INLINE ks_pop_bitcount_t KSIMD_KERNEL_CALL_CONV ks_popcnt64_soft(uint64_t x)
{
...
static KSIMD_FORCE_INLINE ks_pop_bitcount_t KSIMD_KERNEL_CALL_CONV ks_popcnt32_soft(uint32_t x)
{
...
static KSIMD_FORCE_INLINE ks_pop_bitcount_t KSIMD_KERNEL_CALL_CONV ks_popcnt16_soft(uint16_t x)
{
...
static KSIMD_FORCE_INLINE ks_pop_bitcount_t KSIMD_KERNEL_CALL_CONV ks_popcnt8_soft(uint8_t x)
{
