...
namespace detail
{
    ...
    {
        KSIMD_DETAIL_OP_TRAITS(BaseOpTraits<Instruction, Scalar>)
...
#pragma endregion
    ...
    {
        KSIMD_DETAIL_OP_TRAITS(BaseOpTraits<Instruction, SignedType>)
    ...
    {
        KSIMD_DETAIL_OP_TRAITS(BaseOpTraits<Instruction, FloatingPoint>)
