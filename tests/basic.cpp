...
TEST(base_op, float32)
{
    ...
    // scalar
    {
        ...
        static_assert(op::BatchSize == 16);
        static_assert(op::ElementSize == 4);
        static_assert(op::Lanes == 4);
        static_assert(op::BatchAlignment == alignof(float32));
        static_assert(op::RegSize == 16);
        static_assert(op::RegCount == 1);
        static_assert(op::RegStride == 4);
    }
    // sse
    {
    ...
    // avx
    {
        ...
        static_assert(op::BatchSize == 32);
        static_assert(op::ElementSize == 4);
        static_assert(op::Lanes == 8);
        static_assert(op::BatchAlignment == 32);
        static_assert(op::RegSize == 32);
        static_assert(op::RegCount == 1);
        static_assert(op::RegStride == 8);
    }
    // avx2
    {
...
TEST(base_op, float64)
{
    ...
    // scalar
    {
        ...
        // static_assert(op::CurrentInstruction == SimdInstruction::Scalar);
        static_assert(op::BatchSize == 16);
        static_assert(op::ElementSize == 8);
        static_assert(op::Lanes == 2);
        static_assert(op::BatchAlignment == alignof(float64));
        static_assert(op::RegSize == 16);
        static_assert(op::RegCount == 1);
        static_assert(op::RegStride == 2);
    }
    // sse
    {
